 ...
 */
@Database(entities = {Brigde.class, Inspection.class, Inspector.class}, version = 1)
public abstract class AppDatabase extends RoomDatabase {

    public abstract BrigdeDao brigdeDao();
    public abstract Inspection inspectionDao();
    public abstract Inspector inspectorDao();
}
